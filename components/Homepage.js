    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center h-[72vh] gap-10'>
                ...
                <div className='flex justify-around'>
                    <div className='flex flex-col items-center gap-3'>
                        <img className=' bg-slate-400 rounded-full p-3 h-32 w-32' src="/dollar.gif" alt="Image Not Found" />
                    ...
                    <div className='flex flex-col items-center gap-3'>
                        <img className=' bg-slate-400 rounded-full p-3 h-32 w-32' src="/target.gif" alt="Image Not Found" />
                        <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-col items-center gap-3'>
                        <img className=' bg-slate-400 rounded-full p-3 h-32 w-32' src="/goal.gif" alt="Image Not Found" />
                        <div className='flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col justify-center h-[73vh] gap-10 px-36'>
                <h1 className='text-3xl major text-center font-bold'>Learn More About Us</h1>
